...
public class ProductEntityMapper {
    ...
    public ProductEntity toEntity(Product product){
        return new ProductEntity(product.getProductNumber(), product.getName(), product.getPrice(), product.getCategory());
    }
    ...
    public Product toDomain(ProductEntity entity){
        return new Product(entity.getProductNumber(), entity.getName(), entity.getPrice(), entity.getCategory());
    }
