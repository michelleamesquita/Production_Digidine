...
public class OrderEntityMapper {
    ...
    public OrderEntity toEntity(Order order){
        ...
        return new OrderEntity(order.getOrderNumber(), order.getProducts(), order.getOrderStatus(), order.getCreatedAt());
    }

    public Order toDomain(OrderEntity entity){
        return new Order(entity.getOrderNumber(), entity.getProducts(), entity.getOrderStatus(), entity.getCreatedAt());
    }
